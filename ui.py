...
"border-radius:10px;")
        ...
        self.display_table.setRowCount(3)
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.display_table.setItem(1, 2, item)
...
"font: 17pt \"幼圆\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.display_table.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "New Row"))
        item = self.display_table.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "New Row"))
        item = self.display_table.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "New Row"))
        ...
        __sortingEnabled = self.display_table.isSortingEnabled()
        self.display_table.setSortingEnabled(False)
        item = self.display_table.item(1, 0)
        item.setText(_translate("MainWindow", "2342"))
        item = self.display_table.item(1, 1)
        item.setText(_translate("MainWindow", "3423"))
        item = self.display_table.item(1, 2)
        item.setText(_translate("MainWindow", "234"))
        self.display_table.setSortingEnabled(__sortingEnabled)
